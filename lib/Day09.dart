...
Future<void> day09() async {
  var file = File('input/Day09.txt');
  ...
  //  c.printProgram();
    ...
    var computer = IntcodeComputer(List<int>.from(startingMemory), [1]);
    computer.execute();
    print('Part 1: ${computer.output.first }');

    computer = IntcodeComputer(List<int>.from(startingMemory), [2]);
    computer.execute();
